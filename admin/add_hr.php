...
if(isset($_POST['save'])){
    ...
    $insert = mysqli_query($conn,"
        INSERT INTO users (company_name, first_name, last_name, email, password, role, status)
        VALUES ('{$_SESSION['company_name']}', '$fname', '$lname', '$email', '$pass', 'hr', 'active')
    ");
    ...
    if($insert) {
        ...
        $_SESSION['success'] = "HR Officer created successfully! Login credentials sent to email.";
