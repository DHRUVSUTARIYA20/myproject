...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_num_rows($check) > 0) {
        ...
        $insert = mysqli_query($conn, "
            INSERT INTO users (company_name, first_name, last_name, email, password, role, status, email_verified)
            VALUES ('{$_SESSION['company_name']}', '$fname', '$lname', '$email', '$pass', 'employee', 'active', 1)
        ");
        ...
        if ($insert) {
            ...
            $_SESSION['success'] = "Employee added successfully! Login credentials sent to email.";
