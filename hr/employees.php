                    ...
                    <div class='card h-100 shadow-sm'>
                        <div class='card-body'>
                            <div class='d-flex align-items-center mb-3'>
                                <div style='width: 60px; height: 60px; border-radius: 50%; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); display: flex; align-items: center; justify-content: center; color: white; font-weight: bold; font-size: 1.5rem;'>
                                    {$initials}
                                </div>
                                <div class='ms-3'>
                            ...
                            <div class='mt-3'>
                                <a href='employee_view.php?id={$row['id']}' class='btn btn-sm btn-primary'>View Details</a>
                            </div>
                        </div>
                    </div>
                </div>
