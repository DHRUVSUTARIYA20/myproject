        ...
        <div class="col-md-3">
            <div class="card p-4 text-center">
                ...
                <p class="mb-0" style="font-size: 1.5rem; color: #667eea;">
                    <?php
                    $q = mysqli_query($conn,"SELECT COUNT(*) as total FROM users WHERE role='employee'");
        ...
        <div class="col-md-3">
            <div class="card p-4 text-center">
                ...
                <p class="mb-0" style="font-size: 1.5rem; color: #764ba2;">
                    <?php
                    $today = date('Y-m-d');
                    $q = mysqli_query($conn,"SELECT COUNT(*) as total FROM attendance WHERE date='$today' AND status='present'");
                    echo mysqli_fetch_assoc($q)['total'];
                    ?>
                </p>
                ...
                <table class="table table-sm mt-3">
                    ...
                    <tbody>
                        ...
                        $q = mysqli_query($conn,"
                            ...
                            WHERE a.status IN ('absent', 'halfday')
